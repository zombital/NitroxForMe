...
namespace NitroxServer.Communication.Packets.Processors
{
    class DroppedItemPacketProcessor : AuthenticatedPacketProcessor<DroppedItem>
    {
        ...
        public override void Process(DroppedItem packet, Player droppingPlayer)
        {
            ...
            WorldEntity entity = new WorldEntity(packet.ItemPosition, packet.ItemRotation, NitroxVector3.One, packet.TechType, 0, null, false, packet.Id, null, existsInGlobalRoot, packet.WaterParkId.OrElse(null));
